            ...
            games.forEach(game => {
                ...
                <div class="card">
                    <div class="card-content p-6 flex flex-col justify-between h-full">
                        ...
                        <a href="player.html?core=${game.core}&rom=${game.rom}" target="_blank" rel="noopener noreferrer" class="action-btn text-white font-bold py-3 px-4 rounded-lg w-full text-center mt-4">Jogar Agora</a>
                    </div>
                </div>`;
                linksContainer.insertAdjacentHTML('beforeend', cardHTML);
            });
