document.addEventListener('DOMContentLoaded', () => {
  ...
  // EVENT LISTENERS
  // ===================================
  // Lógica para o aviso de Psiphon
  if (psiphonNotice) {
    const showNotice = () => {
      if (!sessionStorage.getItem('psiphonNoticeDismissed')) {
        psiphonNotice.classList.remove('hidden');
      }
    };
    const hideNotice = () => {
      sessionStorage.setItem('psiphonNoticeDismissed', 'true');
      psiphonNotice.classList.add('hidden');
    };
